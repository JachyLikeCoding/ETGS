...
class Data_From_Images():
    def __init__(self, micrograph_path, save_to, slice, norm_coords, synthetic):
        ...
        paths = glob.glob(self.micrograph_path+"/*.png")
        if(len(paths)>0):
            ...
            if(len(os.listdir(self.micrograph_path))>0):
                ...
                if(len(paths)>0):
                    ...
                    print("Searched in file: "+str(self.micrograph_path+"/*.png"))     
    ...
    def load_angles(self):
        path = glob.glob(os.path.dirname(self.micrograph_path)+"/*rawtlt")
...
parser.add_argument('--micrograph_path', type = str, default='./data/tomo/images', help='Directory of micrographs and rawtlt (default: ./Micrographs/)')
parser.add_argument('--save_to', type = str, default='./data/tomo/TrainingData/', help='Directory to save data (default: ./TrainingData/)')
parser.add_argument('--slice', type = float, default=1, help='normalized slice thickness (default: 1)')
parser.add_argument("--norm_coords", default=False, action="store_true", help="Whether to normalize labels to range [-1,1]")
